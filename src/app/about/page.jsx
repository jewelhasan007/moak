           ...
           <div className='pt-3 border-2xl rounded-3xl w-full shadow-2xl'>
            ...
            <div className='lg:flex justify-around'>
                <div className='space-y-3'>
                     ...
                     <p className=' lg:justify-around w-[550px] text-4xl text-pink-500 p-1 md:text-justify'> I'm a Digital Marketer Based In Bangladesh And This Is A Selection Of My Poersonal And Professional Work.</p>
                </div>
